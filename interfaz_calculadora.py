...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.buton0.clicked.connect(lambda: self.imprimir_simbolo("0"))
        self.boton1.clicked.connect(lambda: self.imprimir_simbolo("1"))
        self.boton2.clicked.connect(lambda: self.imprimir_simbolo("2"))
        self.boton3.clicked.connect(lambda: self.imprimir_simbolo("3"))
        self.boton4.clicked.connect(lambda: self.imprimir_simbolo("4"))
        self.boton5.clicked.connect(lambda: self.imprimir_simbolo("5"))
        self.boton6.clicked.connect(lambda: self.imprimir_simbolo("6"))
        self.boton7.clicked.connect(lambda: self.imprimir_simbolo("7"))
        self.boton8.clicked.connect(lambda: self.imprimir_simbolo("8"))
        self.boton9.clicked.connect(lambda: self.imprimir_simbolo("9"))
        self.boton_mas.clicked.connect(lambda: self.imprimir_simbolo("+"))
        self.boton_menos.clicked.connect(lambda: self.imprimir_simbolo("-"))
        self.boton_multiplicar.clicked.connect(lambda: self.imprimir_simbolo("*"))
        self.boton_dividir.clicked.connect(lambda: self.imprimir_simbolo("/"))
        self.outside = WorkThread()
        self.boton_calcular.clicked.connect( self.operar )
        self.outside.signal.connect(self.finished)
        QtCore.QMetaObject.connectSlotsByName(Form)


    def operar(self):
        self.outside.texto = self.editor.toPlainText()
    ...
    def imprimir_simbolo(self, simbolo):
        self.editor.setPlainText( self.editor.toPlainText()  +  simbolo  )
...
class WorkThread(QThread):
    ...
    def run(self):
        ...
        resultado = operacion.postfixEval( operacion.infixToPostfix(self.texto) )
